...
const LendingLoans = () => {
  ...
  return (
    <>
      <Navb/>
      <Typography variant="h4" sx={{paddingTop: '2rem',marginLeft: '2rem'}}>My Lendings</Typography>
      {lendings.length === 0 ? (
        <div>
          <Box sx={{ m: '2rem',paddingLeft: '2rem'}}>
            <Alert severity="info">
...
// const LeandingLoansScreen = headerWrapper(<LendingLoans />)
