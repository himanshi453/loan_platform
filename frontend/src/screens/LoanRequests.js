...
const LoanRequests = () => {
    ...
    const LoanCard = ({ loanRequest }) => {
        ...
        return (
            <>
                ...
                >
                    <Grid container rowGap={'2rem'} rowSpacing={'1'} >
                        {/* Loan Details */}
                        ...
                        <Grid item md={4} xs={12}>
                            <Box>
                                <Typography
                                    textAlign={'center'}
                                    variant='h5'
                                    sx={{ textDecorationLine: 'underline', paddingBottom: '2rem' }}
                                >
                                    User Details
                                </Typography>
                                <Typography variant='h6'>
    ...
    return (
        <><Navb /><Box>
            <Dialog open={dialogState.open}>
                <Box sx={{ padding: '2rem' }}>
                    ...
                    <TextField
                        ...
                        onChange={(e) => setdialogState((state) => ({
                            ...state,
            ...
            <Typography variant='h4' marginBottom={'1.5rem'} sx={{pl:'2rem', pt:'2rem'}}>
                Loan Requests
            </Typography>
            ...
            {alertMsg.open && (
                <Alert
                    sx={{ my: '1rem' }}
                    onClose={() => setalertMsg({ message: '', open: false, severity: '' })}
...
// const LoanRequestsScreen = headerWrapper(<LoanRequests />)
